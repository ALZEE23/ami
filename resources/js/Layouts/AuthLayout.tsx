  ...
  return (
    <main className="container relative grid h-screen flex-col items-center justify-center lg:max-w-none lg:grid-cols-2 lg:px-0">
      <aside className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
        ...
        <img
          src={
            "https://www.tripsavvy.com/thmb/Qid6z3y2eiQra_FUtoMA64jK878=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/MountBatur4WEB-a3e94537b1794ce982c35ee144ec939d.jpg"
          }
          onLoad={handleImageLoad}
          className={`absolute inset-0 size-full ${loaded ? "block" : "hidden"}`}
        />
        <div className="absolute inset-0 z-10 bg-zinc-900/50"></div>
        <div className="relative z-20 flex items-center text-lg font-semibold">
          Aplikasi Manajemen Inovasi
        </div>
